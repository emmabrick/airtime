package com.example.emmabrick.emmascalculator;
...
import static com.example.emmabrick.emmascalculator.R.id.firstnumber;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText left = (EditText) findViewById(firstnumber);
    ...
    /**
     * A method that gets a fun fact for a given number (the result of the operation performed)
     * @param number
     */
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url + numberValue,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        Toast.makeText(MainActivity.this, "Fun Fact: " + response, Toast.LENGTH_LONG).show();
